...
class SiteController extends Controller
{
	...
	public function actionIndex()
	{
		...
		elseif(isset($usuarioActual) && $usuarioActual->tipoUsuario->nombre == 'Responsable'){
			$this->redirect(array('materiaMaestro/index'));
		}
		elseif(isset($usuarioActual) && $usuarioActual->tipoUsuario->nombre == 'Contador'){
			$this->redirect(array('maestro/contador'));
		}
		else
		{
			$this->render('index');
