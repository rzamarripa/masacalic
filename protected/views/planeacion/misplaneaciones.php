...
$queryPlaneacionPorMateria = 'select p.id, p.materia_aid as matid, p.consecutivo, p.semestre,  p.estrategia, p.tema, p.bloque, 
							p.sesiones, tiempo_estimado, e.id as estatus, e.nombre as nombreestatus
...
//$archivos = Archivo::model()->findAll('materia_did = :mat && maestro_did = :maes', array(':mat'=>$_GET['matid'], ':maes' => $_GET["maestroid"]));
										...
										<div class="btn-group">
											...
											<ul class="dropdown-menu">							
												...
												<li>
													...
													array('planeacion/create','planeacion_id'=>$valor["id"], 'tipoUsuario'=>2)); ?>
												</li>
												<li>
									...
									<td style="width:20px;">
										<div class="btn-group">
											...
											<ul class="dropdown-menu">									
												...
												<li>
													<?php echo CHtml::link('<i class="icon-plus-sign"></i> Crear planeación similar', array('planeacion/create','planeacion_id'=>$valor["id"], 'tipoUsuario'=>2)); ?>
												</li>
												<li>
										...
										<td style="width:20px;">
											<div class="btn-group">
												...
												<ul class="dropdown-menu">							
													...
													<li>										
														<?php echo CHtml::link('<i class="icon-trash"></i> Eliminar', "#", 
														array('submit'=> array('archivo/delete', 'id'=>$valor["id"], 'nombre'=>$valor["nombre"], 'tipoUsuario'=>2), 
