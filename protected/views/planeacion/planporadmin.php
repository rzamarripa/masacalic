...
$connection = Yii::app()->db;
$queryArchivosLiberados = 'select p.id, p.nombre as nombreArchivo, maes.nombre as maestroNombre, mat.nombre as materiaNombre, e.id as estatus, e.nombre as nombreestatus 
							from Archivo as p
							inner join Estatus as e on e.id = p.estatus_did
				...
				<div class="tab-content">
			    	<div class="tab-pane active" id="tab1">
						...
						<div class="tab-pane" id="tab2">
							...
							if(count($planeacionesLiberadas)!=0) { ?>
							<table class="table table-bordered table-striped">
								<tr>
									<td><b><?php echo CHtml::encode('Acciones'); ?></b></td>
									<td><b>Materia</b></td>
