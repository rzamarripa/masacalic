...
<?php $form=$this->beginWidget('BActiveForm', array(
	...
	<div class="<?php echo $form->fieldClass($model, 'metacognicion'); ?>">
		<?php echo $form->labelEx($model,'metacognicion'); ?>
		<div class="input">
			
			<?php echo $form->textArea($model,'metacognicion',array('rows'=>6, 'cols'=>50)); ?>
			<?php echo $form->error($model,'metacognicion'); ?>
		</div>
	</div>
	...
	<div class="<?php echo $form->fieldClass($model, 'tarea'); ?>">
		...
		<div class="input">
			...
			<?php echo $form->textArea($model,'tarea',array('rows'=>6, 'cols'=>500)); ?>
	...
	<div class="<?php echo $form->fieldClass($model, 'estatus_did'); ?>">
		...
		<div class="input">
			...
			<?php echo $form->dropDownList($model,'estatus_did',CHtml::listData(Estatus::model()->findAll('tipoUsuario_did = :x', array(':x' => $_GET['tipoUsuario'])), 'id', 'nombre')); ?>			<?php echo $form->error($model,'estatus_did'); ?>
		</div>
	</div>
