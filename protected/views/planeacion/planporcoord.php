...
$queryArchivosPorMateria = 'select a.id, a.nombre, a.descripcion, e.id as estatusid, e.nombre as estatus, a.materia_did, a.maestro_did
							from Archivo as a
    	...
    	<div class="tab-pane active" id="tab01">
    		...
    		<div class="tabbable"> <!-- Only required for left/right tabs -->
				<ul class="nav nav-tabs">
					...
					<li><a href="#tab6" data-toggle="tab"><i class="icon-trash"></i> Pepelera</a></li>							
				</ul>
				<div class="tab-content">
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu">							
														...
														<li>										
															...
															array('submit'=> array('planeacion/delete', 'id'=>$valor["id"]), 
