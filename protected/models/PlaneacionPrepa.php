...
/**
 * This is the model class for table "Planeacion_Prepa".
 *
 * The followings are the available columns in table 'Planeacion_Prepa':
 * @property string $id
 ...
 */
class PlaneacionPrepa extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return PlaneacionPrepa the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('maestro_aid, materia_aid, semestre, estrategia, tema, problema_significativo, activacion, preguntas_inductivas, competencias_conceptuales, competencias_procedimentales, competencias_actitudinales, cierre_de_clase, metodos_de_evaluacion, bibliograficos, electronicos, necesidades', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'planeacion_didactica' => 'Planeacion Didactica',
			'bloque' => 'Bloque',
			'sesiones' => 'Sesiones',
			...
			'metodos_de_evaluacion' => 'Metodos De Evaluacion',
	...
	public function search()
	{
		...
		$criteria->compare('tareas',$this->tareas,true);
